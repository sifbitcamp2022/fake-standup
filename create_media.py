...
args = {
    ...
    "face": "Wav2Lip/template_standup.mov",
    "audio": "nice1.wav",
    "outfile": "bruh.mp4",
    "static": False,
    "fps": 25,
...
def face_detect(images):
	detector = Wav2Lip.face_detection.FaceAlignment(Wav2Lip.face_detection.LandmarksType._2D, 
...
def make_video(face_path, audio_path, out_file):
	args["face"] = face_path
	...
	wav = Wav2Lip.audio.load_wav(args["audio"], 16000)
